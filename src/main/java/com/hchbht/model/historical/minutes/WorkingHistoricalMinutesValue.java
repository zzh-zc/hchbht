package com.hchbht.model.historical.minutes;
...
/**
 * 工况历史数据表 分钟数据 tj_hchbdb_working_historicalminutesvalue
 * @author Administrator
 *
 */
@Data
@ApiModel(value = "工况历史数据表 分钟数据")
public class WorkingHistoricalMinutesValue implements Serializable{
	...
	@Transient
	private List<WorkingHistoricalMinutesValue> list;		//次级、三级数据
