...
/**
 * 环境质量，油烟历史数据表 分钟数据   tj_hchbdb_lampblack_historicalminutesvalue
 * @author Administrator
 *
 */
@Data
@ApiModel(value = "环境质量，油烟历史数据表 分钟数据")
public class LampblackHistoricalMinutesValue implements Serializable{
