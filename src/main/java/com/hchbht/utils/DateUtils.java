...
public class DateUtils {
     ...
     * @return
     */
    public static Date parseMeetingTime(String dateTimeStr) {
        try {
            if (dateTimeStr.contains("-")) {
            } else if (dateTimeStr.contains(".")) {
                dateTimeStr = dateTimeStr.replace(".", "-");
            }
            return new SimpleDateFormat(DateUtils.YYYY_MM_DD_HH_MM).parse(dateTimeStr);
        } catch (Exception e) {
            return null;
        }
    }
    ...
    /**
     * 获取指定季度的开始时间，既012-01-1 00:00:00
     *
     * @return
     */
    ...
    /**
     * 获取指定季度的结束时间，既012-03-31 23:59:59
     *
     * @return
     */
